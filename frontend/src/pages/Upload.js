...
import { ImageIcon, Camera, CloudUpload, Loader2, Upload as UploadIcon, Lightbulb } from 'lucide-react';
...
const Upload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/${uploadType === 'wallpaper' ? 'wallpapers' : 'photos'}/upload`, {
        method: 'POST',
        headers: {
